...
CONFIG=projects/aligncl/experiments/ucit_vicuna_v15_7b_abalation_temp/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_vicuna_v15_7b_abalation_temp/train.sh

WORKDIR=work_dirs/ucit_vicuna_v15_7b/aligncl_itaa_abalation
