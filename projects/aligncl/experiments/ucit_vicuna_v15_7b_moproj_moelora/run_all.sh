...
CONFIG=projects/aligncl/experiments/ucit_vicuna_v15_7b_moproj_moelora/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_vicuna_v15_7b_moproj_moelora/train.sh

WORKDIR=work_dirs/ucit_vicuna_v15_7b/aligncl_moproj_moelora
