...
CONFIG=projects/aligncl/experiments/ucit_vicuna_v15_7b/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_vicuna_v15_7b/train.sh

WORKDIR=work_dirs/ucit_vicuna_v15_7b/aligncl
