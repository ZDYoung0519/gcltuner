...
CONFIG=projects/aligncl/experiments/ucit_vicuna_v15_7b_rank8/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_vicuna_v15_7b_rank8/train.sh

WORKDIR=work_dirs/ucit_vicuna_v15_7b/aligncl_rank8
