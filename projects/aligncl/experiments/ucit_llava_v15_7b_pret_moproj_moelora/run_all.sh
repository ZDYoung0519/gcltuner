...
CONFIG=projects/aligncl/experiments/ucit_llava_v15_7b_pret_moproj_moelora/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_llava_v15_7b_pret_moproj_moelora/train.sh

WORKDIR=work_dirs/ucit_llava_v15_7b_pret/aligncl_moproj_moelora
