...
CONFIG=projects/aligncl/experiments/ucit_llava_v15_7b_inst_rank8/config.py
TRAIN_SCRIPT=projects/aligncl/experiments/ucit_llava_v15_7b_inst_rank8/train.sh

WORKDIR=work_dirs/ucit_llava_v15_7b_inst/aligncl_rank8
