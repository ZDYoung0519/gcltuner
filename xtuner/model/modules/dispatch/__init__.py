...
ATTN_DISPATCH_MAPPING = dict(
    InternLM3Attention=LazyObject(
        "xtuner.model.modules.dispatch.internlm3", "internlm3_attn_forward"
    ),
    ...
    LlamaAttention=LazyObject(
        "xtuner.model.modules.dispatch.llama", "llama_attn_forward"
    ),
    Phi3FlashAttention2=LazyObject(
        "xtuner.model.modules.dispatch.phi3", "phi3_attn_forward"
    ),
    MistralAttention=LazyObject(
        "xtuner.model.modules.dispatch.mistral", "mistral_attn_forward"
    ),
    MixtralAttention=LazyObject(
        "xtuner.model.modules.dispatch.mistral", "mistral_attn_forward"
    ),
    CohereFlashAttention2=LazyObject(
        "xtuner.model.modules.dispatch.cohere", "cohere_attn_forward"
    ),
    Qwen2Attention=LazyObject(
        "xtuner.model.modules.dispatch.qwen2", "qwen2_attn_forward"
    ),
    Qwen2MoeAttention=LazyObject(
        "xtuner.model.modules.dispatch.qwen2", "qwen2_attn_forward"
    ),
...
VARLEN_ATTN_DISPATCH_MAPPING = dict(
    ...
    InternLM2FlashAttention2=LazyObject(
        "xtuner.model.modules.dispatch.internlm2", "internlm2_varlen_attn_forward"
    ),
    InternLMAttention=LazyObject(
        "xtuner.model.modules.dispatch.internlm", "internlm_varlen_attn_forward"
    ),
    LlamaAttention=LazyObject(
        "xtuner.model.modules.dispatch.llama", "llama_attn_forward"
    ),
    Phi3FlashAttention2=LazyObject(
        "xtuner.model.modules.dispatch.phi3", "phi3_varlen_attn_forward"
    ),
    MistralAttention=LazyObject(
        "xtuner.model.modules.dispatch.mistral", "mistral_attn_forward"
    ),
    ...
    DeepseekV2FlashAttention2=LazyObject(
        "xtuner.model.modules.dispatch.deepseek_v2", "deepseek_varlen_attn_forward"
    ),
    InternLM3FlashCrossAttention2=LazyObject(
        "xtuner.model.modules.dispatch.internlm3", "internlm3_cross_attn_varlen_forward"
    ),
    InternLM3FlashSelfAttention2=LazyObject(
        "xtuner.model.modules.dispatch.internlm3", "internlm3_self_attn_varlen_forward"
    ),
)

RMS_DISPATCH_MAPPING = dict(
    InternLM3RMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    InternLM2RMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    InternLMRMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    LlamaRMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    Phi3RMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    MistralRMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    MixtralRMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    CohereLayerNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "layer_norm_forward"
    ),
    Qwen2RMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
    Qwen2MoeRMSNorm=LazyObject(
        "xtuner.model.modules.dispatch.triton_kernels", "rms_norm_forward"
    ),
)
...
def dispatch_varlen_attn_forward(model):
    ...
    for module in model.modules():
        ...
        if name in VARLEN_ATTN_DISPATCH_MAPPING:
            ...
            print_log(
                f"Dispatch {name} varlen forward. {NO_ATTN_WEIGHTS_MSG}", "current"
            )
