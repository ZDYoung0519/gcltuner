...
def modify_config(config, dataset_save_folder):
    dataset = ConfigDict(
        type=LazyObject("datasets", "load_from_disk"), dataset_path=dataset_save_folder
    )
...
if __name__ == "__main__":
    ...
    print(f"Processed dataset has been saved to {processed_dataset_save_folder}")
    ...
    print(
        f"Modified config has been saved to {modified_cfg_save_path}. "
