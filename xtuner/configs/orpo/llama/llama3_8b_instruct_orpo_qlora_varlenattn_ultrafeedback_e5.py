...
from xtuner.engine.hooks import EvaluateChatHook, VarlenAttnArgsToMessageHubHook
...
train_dataset = dict(
    ...
    dataset=dict(
        type=load_dataset, path="argilla/ultrafeedback-binarized-preferences-cleaned"
    ),
    tokenizer=tokenizer,
