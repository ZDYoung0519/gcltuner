...
def moss_003_sft_dataset(
    ...
    plugins = moss_003_sft_plugins_dataset(
        tokenizer, data_file=plugins_data_file, bot_name=bot_name, max_length=max_length
    )
...
def moss_003_sft_no_plugins_dataset(
    tokenizer, data_file=None, bot_name=None, max_length=2048
):
...
def moss_003_sft_plugins_dataset(
    tokenizer, data_file=None, bot_name=None, max_length=2048
):
    # Download data from https://huggingface.co/datasets/fnlp/moss-003-sft-data
    if data_file is None:
